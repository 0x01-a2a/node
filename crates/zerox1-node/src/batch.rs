...
use zerox1_protocol::{
    batch::{BehaviorBatch, FeedbackEvent, TaskSelection, TypedBid, VerifierAssignment},
...
impl BatchAccumulator {
    ...
    pub fn record_notarize_assign(&mut self, va: VerifierAssignment) {
        self.verifier_assignments.push(va);
    }
    ...
    pub fn record_verdict_received(&mut self) {
