...
export interface InboundEnvelope<T extends string = string> {
  msg_type: T
  sender: string            // 64-char hex (32-byte Ed25519 public key)
  recipient: string         // 64-char hex
  conversation_id: string   // 32-char hex (16-byte random ID)
  nonce: number
  payload_b64: string       // base64-encoded raw payload bytes
  /** Pre-decoded by the node — only present on FEEDBACK messages. */
  feedback?: FeedbackPayload
}

// ============================================================================
// Decoded negotiation payload types
// ============================================================================

export interface ProposePayload {
  message: string
  amount_micro: bigint      // USDC micro-units (1 USDC = 1_000_000)
  max_rounds: number
}
...
// ============================================================================
// Aggregator types (common baseline — platforms extend as needed)
// ============================================================================
...
export interface ActivityParams {
  limit?: number
  before?: number     // cursor: last seen ID
}
